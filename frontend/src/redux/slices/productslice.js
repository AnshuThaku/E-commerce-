...
// Async thunk to fetch products by filters (with debouncing)
export const fetchProductByFilters = createAsyncThunk(
  "products/fetchByFilters",
  async ({ collection, ...queryParams }) => {
    ...
    console.log("🛰️ Final query:", query.toString());
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProductDetails.rejected, (state, action) => {
        state.loading = false;
        state.error = "Product details not found.";
      })
