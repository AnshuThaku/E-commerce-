      ...
      <div className="relative shadow-md sm:rounded-lg overflow-x-auto">
        <table className="min-w-full w-full text-left text-gray-500">
          <thead className="bg-gray-100 text-xs uppercase text-gray-700">
            <tr>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Image</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Order ID</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Created</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Shipping Address</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Items</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Price</th>
              <th className="py-2 px-4 sm:py-3 sm:px-6">Status</th>
            </tr>
          </thead>
          <tbody>
            {orders?.length > 0 ? (
